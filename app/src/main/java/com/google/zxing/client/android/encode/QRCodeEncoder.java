...
public final class QRCodeEncoder {
    ...
    public void requestBarcode(Handler handler, int pixelResolution) {
        Thread encodeThread = new com.google.zxing.client.android.encode.EncodeThread(contents, handler, pixelResolution,
                format);
        encodeThread.start();
    }

    public void requestQRCode(String data, int pixelResolution, OnCompleteListener onCompleteListener) {
        this.mOnCompleteListener = onCompleteListener;
        Thread encodeThread = new com.google.zxing.client.android.encode.EncodeThread(data, handler, pixelResolution,
    ...
    private void createHandler() {
        handler = new Handler(activity.getMainLooper()) {
            ...
            public void handleMessage(Message message) {
                switch (message.what) {
                    case IDs.encode_succeeded:
                        mOnCompleteListener.onComplete((Bitmap) message.obj);
                        break;
                    case IDs.encode_failed:
    ...
    public void resetConfig(Intent intent){
